...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Runtime', _p + 'runtime'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://chat.whatsapp.com/E8QcShiFEyrGddlExcmVIE",
    mediaType: "FOTO",
